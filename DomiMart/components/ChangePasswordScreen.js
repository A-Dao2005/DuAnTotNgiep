  ...
  return (
    <View style={styles.container}>
      ...
      <View style={styles.headerRow}>
        <Image
          source={{ uri: 'https://sunhouse.com.vn/pic/thumb/large/product/0(112).jpg' }}
          style={styles.avatar}
        />
        <View>
          <Text style={styles.hello}>
            Xin chào, <Text style={{ color: '#E53935' }}>Nguyen Van A</Text>
          </Text>
      ...
      <View style={styles.supportBox}>
        ...
        <TouchableOpacity style={styles.supportBtn}>
          <Text style={styles.supportBtnText}>Liên hệ hỗ trợ giúp tư vấn</Text>
        </TouchableOpacity>
        <TouchableOpacity style={styles.supportBtn}>
          <Text style={styles.supportBtnText}>Thông tin về MGF</Text>
        </TouchableOpacity>
      </View>
      {success && (
